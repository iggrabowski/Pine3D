...
int GlfwWindow::KeyCodeToGlfw(KeyCode code) {
  ...
  case KC::Z:
    return GLFW_KEY_Z;
  case KC::LEFT_BRACKET:
    return GLFW_KEY_LEFT_BRACKET;
  case KC::BACKSLASH:
    return GLFW_KEY_BACKSLASH;
  case KC::RIGHT_BRACKET:
    return GLFW_KEY_RIGHT_BRACKET;
  case KC::GRAVE_ACCENT:
...
KeyCode GlfwWindow::GlfwToKeyCode(int glfwCode, InputDeviceType deviceType) {
  ...
  case InputDeviceType::MOUSE:
    ...
    case GLFW_MOUSE_BUTTON_LEFT:
      return KeyCode::MB_BUTTON_LEFT;
    case GLFW_MOUSE_BUTTON_RIGHT:
      return KeyCode::MB_BUTTON_RIGHT;
    case GLFW_MOUSE_BUTTON_MIDDLE:
      return KeyCode::MB_BUTTON_MIDDLE;
    case GLFW_MOUSE_BUTTON_4:
      return KeyCode::MB_BUTTON_4;
    case GLFW_MOUSE_BUTTON_5:
      return KeyCode::MB_BUTTON_5;
    case GLFW_MOUSE_BUTTON_6:
      return KeyCode::MB_BUTTON_6;
    case GLFW_MOUSE_BUTTON_7:
      return KeyCode::MB_BUTTON_7;
    case GLFW_MOUSE_BUTTON_8:
      return KeyCode::MB_BUTTON_8;
    }
    break;
  // Gamepad buttons
  case InputDeviceType::GAMEPAD:
    ...
    case GLFW_GAMEPAD_BUTTON_A:
      return KeyCode::GAMEPAD_BUTTON_A;
    case GLFW_GAMEPAD_BUTTON_B:
      return KeyCode::GAMEPAD_BUTTON_B;
    case GLFW_GAMEPAD_BUTTON_X:
      return KeyCode::GAMEPAD_BUTTON_X;
    case GLFW_GAMEPAD_BUTTON_Y:
      return KeyCode::GAMEPAD_BUTTON_Y;
    case GLFW_GAMEPAD_BUTTON_LEFT_BUMPER:
      return KeyCode::GAMEPAD_BUTTON_LEFT_BUMPER;
    case GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER:
      return KeyCode::GAMEPAD_BUTTON_RIGHT_BUMPER;
    case GLFW_GAMEPAD_BUTTON_BACK:
      return KeyCode::GAMEPAD_BUTTON_BACK;
    case GLFW_GAMEPAD_BUTTON_START:
      return KeyCode::GAMEPAD_BUTTON_START;
    case GLFW_GAMEPAD_BUTTON_GUIDE:
      return KeyCode::GAMEPAD_BUTTON_GUIDE;
    case GLFW_GAMEPAD_BUTTON_LEFT_THUMB:
      return KeyCode::GAMEPAD_BUTTON_LEFT_THUMB;
    case GLFW_GAMEPAD_BUTTON_RIGHT_THUMB:
      return KeyCode::GAMEPAD_BUTTON_RIGHT_THUMB;
    case GLFW_GAMEPAD_BUTTON_DPAD_UP:
      return KeyCode::GAMEPAD_BUTTON_DPAD_UP;
    case GLFW_GAMEPAD_BUTTON_DPAD_RIGHT:
      return KeyCode::GAMEPAD_BUTTON_DPAD_RIGHT;
    case GLFW_GAMEPAD_BUTTON_DPAD_DOWN:
      return KeyCode::GAMEPAD_BUTTON_DPAD_DOWN;
    case GLFW_GAMEPAD_BUTTON_DPAD_LEFT:
      return KeyCode::GAMEPAD_BUTTON_DPAD_LEFT;
    }
    break;
  default:
...
GlfwWindow::GlfwWindow() {
  ...
  _window = glfwCreateWindow(_settings.width, _settings.height, _settings.title,
                             nullptr, nullptr);
  ...
  if (hidden && !_cursorDisabled) {
    ...
    if (glfwRawMouseMotionSupported()) {
      ...
      Logger::Instance().Warning(
          "GLFW Window : raw mouse motion not supported.");
...
void GlfwWindow::OnUpdate() {
  ...
  if (!OLwindow)
    OLwindow = std::make_unique<ObjLoaderWindow>();
  OLwindow->Show(NULL);
  OLwindow->OnLoad = LoadModel;

  if (!NEwindow)
    NEwindow = std::make_unique<NodeEditorWindow>();
  ...
  //  {
  //      ImGui::Begin("Another Window", &_show_another_window);   // Pass a
...
GLFWwindow *GlfwWindow::GetWindow() const { return _window; }

NodeEditor &GlfwWindow::GetNodeEditor() { return NEwindow->GetNodeEditor(); }
...
ivec2 GlfwWindow::GetSize() { return ivec2(_settings.width, _settings.height); }

bool GlfwWindow::IsOpen() { return !glfwWindowShouldClose(_window); }
...
void GlfwWindow::AddGlfwCallbacks() {
  ...
  glfwSetKeyCallback(_window, [](GLFWwindow *window, int key, int scancode,
    ...
    Application::inputHandler->UpdateKeyboardState(
        0, GlfwToKeyCode(key, InputDeviceType::KEYBOARD), {.value = value});
  });
  ...
  glfwSetMouseButtonCallback(
      _window, [](GLFWwindow *window, int button, int action, int mods) {
        ...
        Application::inputHandler->UpdateMouseState(
            0, GlfwToKeyCode(button, InputDeviceType::MOUSE), {.value = value});
      });

  glfwSetCursorPosCallback(_window, [](GLFWwindow *window, double xpos,
                                       double ypos) {
    // Call ImGui's mouse position callback
    ImGui_ImplGlfw_CursorPosCallback(window, xpos, ypos);

    // Update the mouse position in the input handler
    // Note: xpos and ypos are in screen coordinates, not normalized device
    // coordinates
    Application::inputHandler->UpdateMousePosition(0, static_cast<float>(xpos),
  ...
  glfwSetFramebufferSizeCallback(
      _window, [](GLFWwindow *window, int width, int height) {
        ...
        if (!isnan(aspectRatio)) {
          ...
          Application::renderer->UpdateRenderDimensions();
        }
      });
}
