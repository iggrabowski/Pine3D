...
int main(void) {
  ...
  // test input mapping
  // test key mapping
  // pine::Application::input_handler->MapInputToAction(pine::KeyCode::A, {
  // "test", pine::KEY_ON_PRESS + pine::KEY_ON_RELEASE, -1.0f });
  ...
  //// test mouse mapping
  // pine::Application::input_handler->MapInputToAction(pine::KeyCode::MB_BUTTON_LEFT,
  // { "test_mouse", pine::KEY_ON_PRESS + pine::KEY_ON_RELEASE, 1.0f });
