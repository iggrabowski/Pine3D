...
namespace pine {
	...
	MeshData::MeshData(std::vector<glm::vec3>& positions)
	{
		this->m_Positions = positions;
	}

	MeshData::MeshData(std::vector<glm::vec3>& positions, std::vector<unsigned int>& indices)
	{
		this->m_Positions = positions;
		this->m_Indices = indices;
	}

	MeshData::MeshData(std::vector<glm::vec3>& positions, std::vector<glm::vec2>& uv, std::vector<glm::vec3>& normals)
	{
		this->m_Positions = positions;
		this->m_TexCoords = uv;
	...
	MeshData::MeshData(std::vector<glm::vec3>& positions, std::vector<glm::vec2>& uv, std::vector<unsigned int>& indices)
	{
		this->m_Positions = positions;
		this->m_TexCoords = uv;
		this->m_Indices = indices;
	...
	MeshData::MeshData(std::vector<glm::vec3>& positions, std::vector<glm::vec2>& uv, std::vector<glm::vec3>& normals, std::vector<unsigned int>& indices)
	{
		this->m_Positions = positions;
		this->m_TexCoords = uv;
		this->m_Normals = normals;
